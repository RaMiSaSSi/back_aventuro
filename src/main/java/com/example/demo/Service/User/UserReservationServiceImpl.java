// java
        // File: src/main/java/com/example/demo/Service/User/UserReservationServiceImpl.java
        ...
        public class UserReservationServiceImpl implements UserReservationService {
            ...
            public ReservationDTO createReservation(ReservationCreateDTO dto) {
                ...
                if (dto.getUserId() != null) {
                    ...
                    // if a userId was provided but not found, fail
                ...
                if (user != null) {
                    r.setUser(user);
                    // optional: clear manual client fields when using registered user
                    r.setClientNom(null);
                ...
                // compute montant total: adults*prix (keep existing logic)
